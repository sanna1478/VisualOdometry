function [transformations] = EssentialMatrixToCameraMatrix(e)
...
transformations(:,:,1) = [rot1,t1;0 0 0 1];
transformations(:,:,2) = [rot2,t2;0 0 0 1];
transformations(:,:,3) = [rot1,t2;0 0 0 1];
transformations(:,:,4) = [rot2,t1;0 0 0 1];